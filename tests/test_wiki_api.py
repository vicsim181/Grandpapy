...
class Test_wikipedia():
    ...
    """
    def mock_get_wiki_answer(self, lat, lng):
        answer = {
            "batchcomplete": "",
            "query": {
                "geosearch": [
    ...
    def test_treatment_wiki_answer_to_decide_which_element_to_display(self, monkeypatch):
        """
    ...
    def test_search_for_correspondence(self, monkeypatch):
        """
        ...
        wiki_test_2.answer = self.mock_get_wiki_answer(lat, lng)
        monkeypatch.setattr('my_app.wiki_api.Wikipedia.get_wiki_answer', self.mock_get_wiki_answer)
